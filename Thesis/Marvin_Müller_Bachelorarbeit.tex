...
\\
\textbf{\underline{6. Halluzinationsrate (HR):}}\\
\\
...
\noindent Dabei sind:
\begin{itemize}
    \item $H$ Anzahl der erkannten Halluzinationen in den generierten Testfällen,
    \item $T$ die Gesamtanzahl der generierten Testfälle.
\end{itemize}
