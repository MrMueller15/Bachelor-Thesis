...
In dieser Arbeit gibt es zwei Qualitätsmetriken, die Testfallstruktur und die Kohärenzrate (KR). Die von GPT-4 von \textcite{OpenAI2025} generierten Testfälle müssen beide erfüllen, damit sie mit den Qualitätskriterien bewertet werden können.\\
\\
