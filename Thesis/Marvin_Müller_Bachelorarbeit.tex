...
Ein Testfall besitzt eine ID, einen Namen, eine Beschreibung, Vorbedingungen welche erfüllt sein müssen, damit der Testfall durchgeführt werden kann, Ziele die erreicht werden sollen (\cite{IsoIecIeee2024}). Folgende Graphik zeigt ein Testfalldesign für eine SAP Applikation:
