...
\\
\textbf{Ist es möglich, dass das LLM GPT-4o von \textcite{OpenAI2025} dazu in der Lage ist, aus Anforderungsspezifikationen Anforderungstestfälle zu erzeugen, die eine hohe Qualität in Bezug auf ihre Abdeckung, Factual Correctness und Testfallstruktur nach \textcite{IsoIecIeee2024} aufweisen?}\\  
\\
...
\\
Die Abdeckung wird für jedes Testszenario einzeln bewertet und danach wird der Mittelwert aus allen Testfällen berechnet. Die Streuung wird mit einem Boxplot dargestellt.
\newpage
...
\begin{figure}[H]
    ...
    \label{fig:enter-label}
\end{figure}
\noindent Anhand dieser Grafik ist zu erkennen, dass die Abdeckung pro Testszenario Schwankungen enthält, diese jedoch nie unter 50 \% fällt.
