...
\\
\textbf{\underline{Problem der Halluzination}}\\
\\
...
\\
\textbf{\underline{1.2 Halluzinationsrate (HR):}}\\
\\
Mit dem Qualitätskriterium Halluzinationsrate (HR) wird in dieser Arbeit, an \textcite{Li2024} angelehnt, das Verhältnis der Anzahl der Halluzinationen pro Testfall und der Gesamtzahl an Testschritten des Testfalls gemessen.
\begin{equation*}
...
\noindent Dabei sind:
\begin{itemize}
    \item $H$ Anzahl der Halluzinationen Testschritte pro Testfall,
...
\\
\textbf{Halluzinationsrate:} 
\begin{table}[H]
 \begin{center}
\begin{tabular}{|l|l|l|l|}
\hline
               & 1. Positiv & 2. Neutral & 3. Negativ  \\ \hline
Anteil H in \%  & 0 - 10 \%       & 11-20\%        & 20 \% <        \\ \hline

\end{tabular}
\end{center}
\end{table}
\noindent Es wird eingeordnet wie viel Prozent \% der Testfälle in welcher der drei Kategorien landen. Anschließend wird der Mittelwert berechnet um die Gesamtrate aller Testfälle zu ermitteln.
