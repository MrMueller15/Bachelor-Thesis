...
In dieser Arbeit gibt es vier Qualitätsmetriken nach \textcite{Wang2024}. Diese werden verwendet, um die Qualität von durch ChatGPT-4 von \textcite{OpenAI2025} generierten Testfälle, welche die Ausschlusskriterien erfüllen, zu bewerten. Die von \textcite{Wang2024} erstellten, Qualitätsmetriken können zusammen mit den Ausschlusskriterien, die vier Qualitätskriterien nach \textcite{Tran2025} auswerten.\\
\\
\textbf{\underline{2.1 Accuracy (Deutsch: Genauigkeit)}}\\
\\
\textbf{\underline{2.2 Precision (Deutsch: Präzision)}}\\
\\
\textbf{\underline{2.3 Recall (Deutsch: Abdeckungsgrad)}}\\
\\
