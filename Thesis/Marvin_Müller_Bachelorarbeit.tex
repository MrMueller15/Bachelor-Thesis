...
\begin{figure} [H]
    ...
    \label{fig:enter-label}
\end{figure}
\noindent Der Prompt ist dabei so geschrieben, dass ChatGPT-4 von \textcite{OpenAI2025} Schritt für Schritt weis, welche Aufgaben es erfüllen soll. Er soll dabei die Informationen aus der Anforderungsspezifikation und aus den Screenshots benutzen und dabei die Struktur aus \parencite{IsoIecIeee2024, Istqb2017} erfüllen. Dies ist für Kapitel \ref{sec:ausschlusskriterien} wichtig, da somit die Ausschlusskriterien bereits im Prompt definiert sind und ChatGPT-4 von \textcite{OpenAI2025} diese erfüllen soll.\\
\\
...
In dieser Arbeit gibt es vier Qualitätskriterien nach \textcite{Tran2025}. Diese werden verwendet, um die von ChatGPT-4 von \textcite{OpenAI2025} generierten Testfälle auszuwerten.\\
\\
