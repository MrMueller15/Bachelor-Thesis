...
\noindent Nur wenn ein Testfall die richtige Teststruktur und kohärente Testschritte besitzt, ist es sinnvoll, deren Qualität mit der Qualität von manuell erstellten Testfällen zu vergleichen.
...
In dieser Arbeit gibt es vier Qualitätskriterien nach \textcite{Tran2025}. Diese werden verwendet, um die von ChatGPT-4 von \textcite{OpenAI2025} generierten Testfälle, welche die Ausschlusskriterien erfüllen, mit den manuell erstellten Testfälle zu vergleichen.\\
\\
